...
public class IntroActivity extends AppIntro2
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance(getString(R.string.intro_location), getString(R.string.intro_location_desc), R.drawable.ic_location, Color.parseColor("#009384")));
        addSlide(AppIntroFragment.newInstance(getString(R.string.intro_settings), getString(R.string.intro_settings_desc), R.mipmap.ic_privacy_policy, Color.parseColor("#F0A815")));
