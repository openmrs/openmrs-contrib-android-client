...
public class DailyAppointmentsPresenter extends BasePresenter implements DailyAppointmentsContract.Presenter {
    private DailyAppointmentsContract.View mDailyAppointmentsView;
    public String mQuery;

    public DailyAppointmentsPresenter(DailyAppointmentsContract.View mDailyAppointmentsView) {
        this.mDailyAppointmentsView = mDailyAppointmentsView;
        this.mDailyAppointmentsView.setPresenter(this);
        ...
        call.enqueue(new Callback<Appointment>() {
            ...
            public void onResponse(Call<Appointment> call, Response<Appointment> response) {
                if (response.isSuccessful()) {
                    ...
                    mDailyAppointmentsView.updateListVisibility(true);
                    mDailyAppointmentsView.updateAdapter(blocks);
                }
