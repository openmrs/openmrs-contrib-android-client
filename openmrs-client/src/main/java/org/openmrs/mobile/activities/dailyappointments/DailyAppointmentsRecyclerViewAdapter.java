...
public class DailyAppointmentsRecyclerViewAdapter extends RecyclerView.Adapter<DailyAppointmentsRecyclerViewAdapter.ServicesViewHolder> {
    private DailyAppointmentsFragment mContext;
    private List<Result> mItems;

    public DailyAppointmentsRecyclerViewAdapter(DailyAppointmentsFragment context, List<Result> items) {
        this.mContext = context;
        this.mItems = items;
    }

    @Override
    public DailyAppointmentsRecyclerViewAdapter.ServicesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_appointment_row, parent, false);
        FontsUtil.setFont((ViewGroup) itemView);
        return new DailyAppointmentsRecyclerViewAdapter.ServicesViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(DailyAppointmentsRecyclerViewAdapter.ServicesViewHolder holder, final int position) {
