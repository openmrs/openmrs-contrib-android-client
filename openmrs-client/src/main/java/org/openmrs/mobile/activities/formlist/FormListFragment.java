...
public class FormListFragment extends ACBaseFragment<FormListContract.Presenter> implements FormListContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        formList.setOnItemClickListener(
            (parent, view, position, id) -> mPresenter.listItemClicked(position, ((TextView) view).getText().toString()));
    ...
    public void showFormList(String[] forms) {
        formList.setAdapter(
            new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1, android.R.id.text1, forms));
    }
