            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case ON_SUCCESS:
                        ...
                        ToastUtil.INSTANCE.success(Resources.getSystem().getString(R.string.patient_update_successful, updateSuccessPatientName));
                        break;
                    case ON_FAILURE:
                        String updateFailedPatientName = (String) msg.obj;
                        ToastUtil.INSTANCE.error(Resources.getSystem().getString(R.string.patient_update_unsuccessful, updateFailedPatientName));
                        break;
                    case ON_UNSUCCESSFUL_RESPONSE_PHOTO_UPDATE:
                        responseMessage = (String) msg.obj;
                        ToastUtil.INSTANCE.error(Resources.getSystem().getString(R.string.patient_photo_update_unsuccessful, responseMessage));
                    case ON_FAILURE_RESPONSE_PHOTO_UPDATE:
                        responseMessage = (String) msg.obj;
                        ToastUtil.INSTANCE.notify(Resources.getSystem().getString(R.string.patient_photo_update_unsuccessful, responseMessage));
                }
