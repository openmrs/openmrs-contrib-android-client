...
class PersonUpdate : Resource, Serializable {
    /**
     * @return The names
     */
    /**
    ...
    @Expose
    var names: List<PersonName> = ArrayList()
    ...
    @Expose
    var addresses: List<PersonAddress> = ArrayList()
    ...
    constructor(names: List<PersonName>, gender: String?, birthdate: String?, birthdateEstimated: Boolean, addresses: List<PersonAddress>, attributes: List<PersonAttribute>,
                photo: Bitmap?, causeOfDeath: String?, dead: Boolean) {
        this.names = names
        this.gender = gender
